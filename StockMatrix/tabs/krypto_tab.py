...
def krypto_tab():
    ...
    interval = st.selectbox("Interwał:", ["1d", "1h", "4h", "1wk"], key=f"interval_{ticker}")
    ...
    cols[3].metric("Volatility (30d)", f"{vol30:.2f}%", key=f"vol_{ticker}")
